...
<div class="container">
	<h2>Generador de código de barras PHP</h2>	
	<br>
	<br>
	<div class="row">	
		<div class="col-md-4">
			<form method="post">
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							<label>Nombre o número a generar</label>
				...
				<div class="row">
					<div class="col-md-6">
						 <div class="form-group">
							 <label>Forma de mostrar código</label>
				...
				<div class="row">
					<div class="col-md-7">
						...
						<input type="submit" name="generateBarcode" class="btn btn-primary form-control" value="Generar codigo">
					</div>
				</div>
			</form>
		</div>
		 ...
		 <?php
			if(isset($_POST['generateBarcode'])) {
				...
				if($barcodeText != '') {
					...
					echo '<div class="alert alert-danger">Ingresa Nombre o número a generar</div>';
				}
			}
		?>
		</div>
